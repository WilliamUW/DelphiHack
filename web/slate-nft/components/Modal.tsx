          ...
          <div className="relative my-6 mx-auto w-auto max-w-3xl">
            <div className="flex relative flex-col w-full bg-stone-800 rounded-lg border-[1px] border-slate-200/20 border-solid outline-none focus:outline-none shadow-lg">
              <div className="flex justify-between items-start p-5 rounded-t border-b border-slate-200/20 border-solid">
                <h3 className="text-3xl font-bold">Before using Slate NFT...</h3>
              </div>
              <div className="relative flex-auto p-6 my-4">
                <p className="text-lg leading-relaxed">
                  Slate NFT is a decentralized application where individuals or communities can use smart contract
                  ...
                  <br />
                  Slate NFT is made up of free, public, and open-source software that is built on top of Juno Network.
                  Slate NFT only provides tools for any of the mentioned functionalities above and inside the dApp.
                  Anyone can airdrop or generate tokens on Slate NFT. Slate NFT does not search for any criteria for
                  airdrop listings, does not audit the functionality of the tokens. <br />
                  <br />
                  AS DESCRIBED IN THE DISCLAIMER, Slate NFT IS PROVIDED “AS IS”, AT YOUR OWN RISK, AND WITHOUT
                  WARRANTIES OF ANY KIND. No developer or entity involved in creating the Slate NFT will be liable for
                  any claims or damages whatsoever associated with your use, inability to use, or your interaction with
                  other users of the Slate NFT, including any direct, indirect, incidental, special, exemplary, punitive
              ...
              <div className="flex justify-center">
                <Radio
                  ...
                  subtitle=""
                  title="I understand the risks and disclaimer of using Slate NFT"
                />
              </div>
